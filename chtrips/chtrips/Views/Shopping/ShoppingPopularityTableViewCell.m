...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [_productImage autoSetDimensionsToSize:CGSizeMake(75, 60)];
        ...
        [_priceZHLB autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_titleJPLB withOffset:5];
        ...
        _summaryLB.font = [UIFont fontWithName:@"Arial" size:12];
